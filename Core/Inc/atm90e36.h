...
#ifndef INC_ATM90E36_H_
#define INC_ATM90E36_H_
...
//void ATM90E36A_Select(void);
//void ATM90E36A_Deselect(void);
//uint16_t ATM90E36A_ReadRegister(uint8_t address);
//void ATM90E36A_WriteRegister(uint8_t address, uint16_t value);
void ATM90E36A_Init();
